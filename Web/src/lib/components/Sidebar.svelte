<script>
  ...
  <Sidebar asideClass="flex hidden fixed top-0 left-0 z-20 flex-col flex-shrink-0 pt-16 w-64 h-full duration-200 lg:flex transition-width">
    <SidebarWrapper>
      <SidebarGroup>
        ...
        <SidebarItem label="Sign In" href='/login' active={activeUrl === '/login'}>
          <svelte:fragment slot="icon">
