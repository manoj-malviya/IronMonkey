# Requirements Archive: v1.1 Tenant Onboarding with Industry Recipes
...
- [x] **ONBD-01**: User can select an industry recipe during tenant signup
- [x] **ONBD-02**: User can preview what a recipe includes (stages, fields, rules) before committing to it
- [x] **ONBD-03**: Tenant provisioning atomically applies the selected recipe — seeding stages, fields, rules, roles, and sample data in a single transaction
- [x] **ONBD-04**: All recipe-seeded configuration is fully modifiable by the tenant after provisioning
- [x] **ONBD-05**: System provides a list of available recipes via API endpoint

### Recipe Administration

- [x] **RADM-01**: Admin can create new industry recipes via API
- [x] **RADM-02**: Admin can update existing recipe definitions via API
- [x] **RADM-03**: Admin can deactivate (soft-delete) a recipe so it no longer appears in the selection list
...
| ONBD-01 | Phase 8 | Complete |
| ONBD-02 | Phase 8 | Complete |
| ONBD-03 | Phase 8 | Complete |
| ONBD-04 | Phase 8 | Complete |
| ONBD-05 | Phase 8 | Complete |
| RADM-01 | Phase 8 | Complete |
| RADM-02 | Phase 8 | Complete |
| RADM-03 | Phase 8 | Complete |
